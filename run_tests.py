...
def run_linting():
    ...
    commands = [
        ([sys.executable, "-m", "black", "--check", "."], "Code formatting check (black)"),
        ([sys.executable, "-m", "isort", "--check-only", "."], "Import sorting check (isort)"),
...
def main():
    ...
    parser.add_argument("--coverage-only", action="store_true",
                       help="Only check coverage threshold")
