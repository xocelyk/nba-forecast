...
class TestCalculateDynamicHca:
    ...
    def test_calculate_dynamic_hca_different_prior_weight(self):
        ...
        result_low_weight = utils.calculate_dynamic_hca(games, prior_mean=2.5, prior_weight=1.0)
        
        # High prior weight should keep result closer to prior
        result_high_weight = utils.calculate_dynamic_hca(games, prior_mean=2.5, prior_weight=100.0)
